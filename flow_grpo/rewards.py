...
def clip_score(device):
    ...
    # Create an object that has both the function and the scorer attributes
    class ClipScoreWrapper:
        def __init__(self, fn, scorer):
            self._fn = fn
    ...
    return ClipScoreWrapper(_fn, scorer)
...
def pickscore_score(device):
    ...
    # 模仿clipscore，创建一个带有函数和scorer属性的对象
    class PickScoreWrapper:
        def __init__(self, fn, scorer):
            self._fn = fn
            self.model = scorer.model
            self.processor = scorer.processor
    ...
    return PickScoreWrapper(_fn, scorer)
...
def multi_score(device, score_dict):
    ...
    # Create an object that has both the function and score_fns attribute
    class MultiScoreWrapper:
        def __init__(self, fn, score_fns):
            self._fn = fn
    ...
    return MultiScoreWrapper(_fn, score_fns)
