...
if __name__ == "__main__":
    ...
    example_image_path = "/pfs/yangyuanming/code2/datasets/fluxkrea-data/pickscore-prompt/test_1/00000094.jpg"
    example_image = Image.open(example_image_path)
    example_prompt = 'New York Skyline with "Hello World" written with fireworks on the sky'
    example_prompt = 'A man holding a sign that says "China is big"'
    # Instantiate scorer
