...
class QwenVLScorer(torch.nn.Module):
    def __init__(self, device="cuda", dtype=torch.bfloat16):
        ...
        self.model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
            ...
            "/pfs/yangyuanming/code2/models/Qwen2.5-VL-7B-Instruct/model/Qwen__Qwen2.5-VL-7B-Instruct/main",
        ...
        self.processor = AutoProcessor.from_pretrained("/pfs/yangyuanming/code2/models/Qwen2.5-VL-7B-Instruct/model/Qwen__Qwen2.5-VL-7B-Instruct/main", use_fast=True)
        self.task = '''
...
def main():
    ...
    images=[
    "/pfs/yangyuanming/code2/datasets/sd3_5m-data/capybara.png",
    ]
