...
def main(_):
    ...
    clip_learning_rate = getattr(config.train, 'clip_learning_rate', 2e-6)
    ...
    if accelerator.mixed_precision in ["fp16", "bf16"]:
        ...
        unwrapped_joint_model = accelerator.unwrap_model(joint_model)
        smart_dtype_conversion(unwrapped_joint_model.transformer, dtype)
        ...
        for param in unwrapped_joint_model.clip_model.parameters():
